...
import { BarChart3, Users, Package, ShoppingBag, TrendingUp, ArrowUpRight } from "lucide-react";
...
export default async function DashboardHome() {
  ...
  return (
    <div className="space-y-10">
      <header>
        <p className="text-xs font-black uppercase tracking-widest text-navy mb-2">Resumen General</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, idx) => (
          <div key={idx} className="bg-background border border-foreground/5 p-6 rounded-3xl shadow-sm hover:shadow-md transition-shadow group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-background border border-foreground/5 p-8 rounded-3xl h-96">
        ...
        <div className="bg-navy text-white p-8 rounded-3xl shadow-2xl shadow-navy/20 flex flex-col justify-between">
          ...
          <button className="bg-white text-navy w-full py-4 rounded-2xl font-black tracking-tight flex items-center justify-center group mt-6">
            Explorar KODA Pro
