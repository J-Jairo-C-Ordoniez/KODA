    ...
    >
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-2">
          <label htmlFor="email" className="block text-xs font-black uppercase tracking-widest text-secondary ml-1">
            Correo Electrónico
          </label>
        ...
        <div className="space-y-2">
          {/* <div className="flex justify-between items-center ml-1">
            <label htmlFor="password" className="block text-xs font-black uppercase tracking-widest text-secondary">
              Contraseña
            </label> */}
          {/* <Link href="/forgot-password" alt="Recuperar contraseña" title="Recuperar contraseña" className="text-[10px] font-black uppercase tracking-widest text-navy hover:underline">
