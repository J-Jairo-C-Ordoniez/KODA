        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
                <Button
                    ...
                    onClick={prevStep}
                    variant="secondary"
                    className="bg-foreground/5 hover:bg-foreground/10 py-4 px-6 rounded-2xl font-bold text-primary border border-foreground/8"
                >
                    <ArrowLeft size={18} />
                </Button>
                <Button
                    ...
                    disabled={loading}
                    variant="contrast"
                    className="grow py-4 rounded-2xl font-black tracking-widest uppercase text-sm"
                >
                    {loading ? (
