...
export default function CardDetail({ title, description, icon: Icon }: CardDetailProps) {
    return (
        <article className="scrolly-card group opacity-0 relative flex flex-col gap-6 bg-background-elevated/40 backdrop-blur-xl border border-foreground/10 rounded-4xl p-8 hover:border-contrast/30 transition-all duration-500 hover:shadow-[0_0_40px_-15px_rgba(255,122,0,0.15)]">
