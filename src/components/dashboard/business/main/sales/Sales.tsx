...
import { ShoppingCart, Calendar, User, CreditCard, ArrowUpRight, Filter, Search, Download } from 'lucide-react';
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-foreground/5">
                {filteredSales.map((sale: any) => (
                  <tr key={sale.saleId} className="hover:bg-foreground/[0.01] transition-colors group">
