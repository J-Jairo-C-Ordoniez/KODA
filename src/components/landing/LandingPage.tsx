...
export const LandingPage = () => {
  return (
    <div className="flex flex-col min-h-screen bg-background text-primary selection:bg-indigo-100 selection:text-indigo-900">
      ...
      >
        <div className="absolute -top-12 right-0 bg-foreground px-4 py-2 rounded-lg rounded-br-none shadow-xl text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity uppercase font-medium tracking-wider text-primary/60">
