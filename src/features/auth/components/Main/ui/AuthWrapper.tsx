  ...
  return (
    <main className="min-h-screen animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      <div className="w-full min-h-screen px-4 sm:px-6 md:px-8 py-10 md:py-20">
        <header className="flex flex-col justify-center items-center mx-auto max-w-6xl pb-8 md:pb-10">
          <h1 className="text-center font-heading text-3xl font-bold leading-[1.05] tracking-tight text-foreground sm:text-4xl md:text-5xl lg:text-6xl">
            {title}
          </h1>
          <p className="text-center mt-4 md:mt-6 max-w-2xl text-sm font-normal leading-relaxed text-foreground/80 sm:text-base md:text-lg px-2">
            {subtitle}
          </p>
        </header>
