...
export default function Menu({ setIsMenuOpen, isOpen }: { setIsMenuOpen: (open: boolean) => void; isOpen: boolean }) {
    ...
    const navLinks = [
        ...
        { name: 'Términos y Condiciones', href: '/legal/termsAndConditions' },
        { name: 'Política de Privacidad', href: '/legal/privacyPolicy' },
        { name: 'Política de Cookies', href: '/legal/cookiesPolicy' },
    ];
