...
export default function SearchView({ tenant, slug }: Props) {
  ...
  return (
    <div className="min-h-screen bg-background text-primary flex flex-col justify-between font-sans selection:bg-contrast/30">
        ...
        <div className="max-w-3xl mx-auto mb-16 space-y-6">
          ...
          <div className="relative border-b-2 border-foreground/20 focus-within:border-contrast transition-colors pt-4 pb-2">
            ...
            {query && (
              <button
                onClick={clearSearch}
                className="absolute right-0 top-1/2 -translate-y-1/2 text-foreground-muted hover:text-primary transition-colors p-1 cursor-pointer"
              >
                <X size={20} />
              </button>
            )}
